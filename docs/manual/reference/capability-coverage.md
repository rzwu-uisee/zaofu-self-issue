...
| `evidence-bound-self-evolution`<br>受证据约束的自我进化与能力积累 | `partial` | [`23-self-evolution-learning.md`](../23-self-evolution-learning.md)<br>[`23-self-evolution-learning.en.md`](../23-self-evolution-learning.en.md) | `src/zf/runtime/evolution_automation.py`<br>`src/zf/runtime/evolution_coordinator.py`<br>`src/zf/runtime/evolution_learning.py`<br>`src/zf/runtime/evolution_trial_runner.py` | `tests/test_evolution_runtime.py`<br>`tests/test_evolution_learning.py`<br>`tests/test_evolution_environment.py`<br>`tests/e2e/test_self_evolution_unattended_e2e.py` |
