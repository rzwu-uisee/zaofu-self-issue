...
| `evidence-bound-self-evolution`<br>Evidence-bound self-evolution and capability accumulation | `partial` | [`23-self-evolution-learning.md`](../23-self-evolution-learning.md)<br>[`23-self-evolution-learning.en.md`](../23-self-evolution-learning.en.md) | `src/zf/runtime/evolution_automation.py`<br>`src/zf/runtime/evolution_coordinator.py`<br>`src/zf/runtime/evolution_learning.py`<br>`src/zf/runtime/evolution_trial_runner.py` | `tests/test_evolution_runtime.py`<br>`tests/test_evolution_learning.py`<br>`tests/test_evolution_environment.py`<br>`tests/e2e/test_self_evolution_unattended_e2e.py` |
...
- **Authority**: Evolution is an evidence and capability lifecycle. It cannot rewrite product Task/Delivery truth; Coordinator never directly edits source, config, Skills, or Memory.
