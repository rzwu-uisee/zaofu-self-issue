...
Last manually verified: `2026-08-21`.
...
| `evidence-bound-self-evolution`<br>Evidence-bound self-evolution and capability accumulation | `partial` | [`23-self-evolution-learning.md`](../23-self-evolution-learning.md)<br>[`23-self-evolution-learning.en.md`](../23-self-evolution-learning.en.md) | `src/zf/runtime/evolution_automation.py`<br>`src/zf/runtime/evolution_automation_support.py`<br>`src/zf/runtime/evolution_coordinator.py`<br>`src/zf/runtime/evolution_learning.py`<br>`src/zf/runtime/evolution_skill.py`<br>`src/zf/runtime/evolution_skill_automation.py`<br>`src/zf/runtime/evolution_skill_campaign.py`<br>`src/zf/runtime/evolution_skill_feedback.py`<br>`src/zf/runtime/evolution_skill_overlay.py`<br>`src/zf/runtime/evolution_skill_provider.py`<br>`src/zf/runtime/evolution_skill_source.py`<br>`src/zf/runtime/evolution_trial_runner.py` | `tests/test_evolution_runtime.py`<br>`tests/test_evolution_learning.py`<br>`tests/test_evolution_environment.py`<br>`tests/test_evolution_skill_overlay.py`<br>`tests/test_evolution_skill_trust.py`<br>`tests/e2e/test_skill_evolution_production_e2e.py`<br>`tests/e2e/test_self_evolution_unattended_e2e.py` |
