...
- [Feishu AI-Native direct bridge](../19-feishu-ai-native-direct-bridge.en.md): group chat, direct chat, approvals, and provider sessions.
- [Feishu Automation / Kanban sync](../11-feishu-automation-kanban-sync.en.md): Daily, Weekly, Project reports, and board projections.
