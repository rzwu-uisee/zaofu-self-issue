...
from zf.runtime.writer_contract_handoff import (
    WriterContractHandoffMixin,
    recoverable_writer_handoff_failure,
)


class WriterFanoutResultBindingMixin(WriterContractHandoffMixin):
    def _writer_source_event_already_terminal(self, source_event_id: str) -> bool:
        ...
        for recorded in reversed(events):
            ...
            if source_event_id in {
                ...
                return not recoverable_writer_handoff_failure(recorded)
        return False
