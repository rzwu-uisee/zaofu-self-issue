...
KNOWN_EVENT_TYPES: frozenset[str] = frozenset({
    ...
    "candidate.owner_review.changes_requested", "candidate.owner_review.declined",
    "candidate.publication.prepared", "forge.pull_request.recorded",
    "forge.pull_request.synced", "delivery.merged",
