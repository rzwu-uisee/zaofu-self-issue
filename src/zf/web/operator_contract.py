...
KANBAN_AGENT_ALLOWED_ACTIONS = (
    ...
    "self-issue-publish",
    "self-issue-recover",
    "self-issue-oauth-start",
    "self-issue-oauth-callback",
    "self-issue-oauth-disconnect",
    "self-issue-github-device-start",
    "self-issue-github-device-poll",
    "self-issue-resolve-unknown",
    "self-issue-get",
    "self-issue-dismiss",
    ...
    "self-issue-attachment-resolve-unknown",
